...
class My_Recent_Posts_Widget extends \WPH_Widget
{
	...
	{
		$args = array(
			'label'       => __('My Recent Posts Example', C_TEXTDOMAIN),
			'description' => __('My Recent Posts Widget Description', C_TEXTDOMAIN),
			'slug'        => 'recent-posts',
		...
		$args['fields'] = array(
			...
			array(
				...
				'class'    => 'widefat',
				// Default value
				'std'      => __('Recent Posts', C_TEXTDOMAIN),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => __('Taxonomy', C_TEXTDOMAIN),
				'desc'  => __('Set the taxonomy.', C_TEXTDOMAIN),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => __('Taxonomy terms', C_TEXTDOMAIN),
				'desc'     => __('Set the taxonomy terms.', C_TEXTDOMAIN),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => __('Pages', C_TEXTDOMAIN),
				'desc'  => __('Set the page.', C_TEXTDOMAIN),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => __('Post type', C_TEXTDOMAIN),
				'desc'     => __('Set the post type.', C_TEXTDOMAIN),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => __('Amount', C_TEXTDOMAIN),
				'desc'     => __('Select how many posts to show.', C_TEXTDOMAIN),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => __('1 Post', C_TEXTDOMAIN),
						'value' => '1',
					),
					array(
						'name'  => __('2 Posts', C_TEXTDOMAIN),
						'value' => '2',
					),
					array(
						'name'  => __('3 Posts', C_TEXTDOMAIN),
						'value' => '3',
					),
			...
			array(
				'name'   => __('Output as list', C_TEXTDOMAIN),
				'desc'   => __('Wraps posts with the <li> tag.', C_TEXTDOMAIN),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize()
	{
		add_action(
			'widgets_init',
			function () {
				register_widget('Coachs\Integrations\Widgets\My_Recent_Posts_Widget');
			}
		);
	}
}
